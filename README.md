...
A constructive greedy pass is followed by deterministic best-improvement hill climbing using add, relocate, swap, split, and merge repacks. The search is reproducible and constraint-preserving but is a finite heuristic, not a mathematical global-optimum guarantee.
